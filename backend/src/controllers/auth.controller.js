  ...
  async login(req, res, next) {
    try {
      ...
      if (!user) {
        ...
        return next(createUnauthorizedError('Invalid email or password'));
      }
      ...
      if (!user.is_active) {
        ...
        return next(createUnauthorizedError('Your account has been deactivated'));
      }
      ...
      if (user.organization_id && !user.organization_active) {
        ...
        return next(createUnauthorizedError('Your organization account is inactive'));
      }
